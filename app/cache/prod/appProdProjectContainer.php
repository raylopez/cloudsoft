...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/assetic/config'), false)));
    ...
    {
        require_once 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/jms_diextra/doctrine/EntityManager_553955ecbb489.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_f1b685d2cae3d2711067ff8a7bb9097a');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_f1b685d2cae3d2711067ff8a7bb9097a');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f1b685d2cae3d2711067ff8a7bb9097a');
        ...
        $d->setProxyDir('C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager553955ecbb489_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod',
            ...
            'session.save_path' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/jms_diextra/doctrine/EntityManager_553955ecbb489.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager553955ecbb489_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'C:/xampp/htdocs/www/proyectos_sf/cloudsoft/app/cache/prod/jms_security',
